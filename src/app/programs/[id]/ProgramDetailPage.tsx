...
import { Program, GitHubRelease, ProgramCategory } from '@/src/app/types/program';
import { formatDate, formatFileSize, getCategoryColor } from '@/src/app/lib/programUtils';
import { 
  Download, 
  Tag, 
  Calendar, 
