        ...
        <Card className="shadow-xl border-0 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <div className="text-slate-700 dark:text-slate-300 leading-relaxed space-y-2">
                <p>
                  1. 서비스 및 서비스 제공자가 직접 제작한 소프트웨어, 화면 구성,
                  디자인, 문서 등에 관한 저작권과 그 밖의 지적재산권은 서비스
                  제공자에게 귀속됩니다. 다만, 별도의 라이선스가 명시된 경우에는
                  해당 라이선스를 따릅니다.
                </p>

                <p>
                  2. 이용자가 서비스 내에 게시하거나 등록한 콘텐츠에 대한 권리는
                  해당 이용자 또는 정당한 권리자에게 귀속됩니다.
                </p>

                <p>
                  3. 이용자는 자신이 서비스 내에 게시하거나 등록한 콘텐츠를 서비스의
                  운영, 제공 및 다른 이용자의 서비스 내 이용을 위하여 필요한 범위에서
                  서비스 제공자가 이용하는 것에 동의합니다.
                </p>

                <p>
                  4. 서비스에서 제공하는 단어 목록, 단어 데이터베이스 및 이에 부수하는
                  데이터 중 서비스 제공자가 권리를 보유하거나 이용허락 권한을 가진
                  데이터(이하 &quot;제공 데이터&quot;)는 별도의 표시가 없는 한{' '}
                  <a
                  ...
                  >
                    크리에이티브 커먼즈 저작자표시-비영리-동일조건변경허락 4.0
                    국제 라이선스(CC BY-NC-SA 4.0)
                  </a>
                  에 따라 이용할 수 있습니다.
                </p>

                <p>
                  5. 제공 데이터를 복제, 배포, 공개, 가공하거나 외부 프로젝트에서
                  이용하는 경우 이용자는 다음 조건을 모두 준수해야 합니다.
                </p>

                <ul className="ml-4 space-y-1">
                  <li>
                    • &quot;끄코 유틸리티(Kkuko Utils)&quot;를 출처로 명시하고
                    서비스로 연결되는 링크를 함께 표시할 것
                  </li>
                  <li>
                    • CC BY-NC-SA 4.0 라이선스의 명칭과 해당 라이선스 안내 페이지의
                    링크를 표시할 것
                  </li>
                  <li>
                    • 제공 데이터를 수정, 번역, 정리, 병합하거나 그 밖의 방법으로
                    변경한 경우 그 변경 사실을 표시할 것
                  </li>
                  <li>• 제공 데이터를 영리 목적으로 이용하지 않을 것</li>
                  <li>
                    • 제공 데이터를 변경하거나 이를 기반으로 결과물을 제작하여 공개하는
                    경우 해당 결과물을 CC BY-NC-SA 4.0 또는 이와 호환되는 라이선스로
                    제공할 것
                  </li>
                  <li>
                    • 라이선스가 허용하는 이용을 제한하는 추가적인 법적 조건이나 기술적
                    보호조치를 적용하지 않을 것
                  </li>
                </ul>

                <p>6. 다음 자료에는 위 라이선스가 적용되지 않습니다.</p>

                <ul className="ml-4 space-y-1">
                  <li>• 이용자가 직접 게시하거나 등록한 콘텐츠</li>
                  <li>
                    • 제3자가 저작권, 데이터베이스제작자권리 또는 그 밖의 권리를
                    보유한 자료
                  </li>
                  <li>• 별도의 출처 또는 이용조건이 표시된 자료</li>
                  <li>• 상표, 로고, 서비스 명칭 및 서비스의 소스코드</li>
                  <li>
                    • 관련 법령에 따라 권리가 서비스 제공자에게 귀속되지 않는 개별
                    단어 또는 사실정보
                  </li>
                </ul>

                <p>
                  7. 제3자의 자료를 이용하는 경우 이용자는 해당 자료에 표시된 출처와
                  이용조건을 별도로 확인하고 준수해야 합니다.
                </p>
