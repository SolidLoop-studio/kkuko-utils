import { GameLogic } from '@/src/app/mini-game/game/lib/GameLogic';
import { WordService } from '@/src/app/mini-game/game/services/WordService';
import { GameSetting, CurrentState } from '@/src/app/mini-game/game/types/game.types';
