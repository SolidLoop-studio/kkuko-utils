...
import * as hooks from '@/src/app/mini-game/game/store/hooks';
import { setPlaying, setPendingStart, setStartBlocked, resetGame } from '@/src/app/mini-game/game/store/gameSlice';
