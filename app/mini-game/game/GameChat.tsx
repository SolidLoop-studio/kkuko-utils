            ...
            >
                {messages.map((message, index) => (
                    <div key={message.id}>
                        ...
                        <div className={`chat-item w-full overflow-hidden p-1 my-1 ${message.isNotice ? 'bg-gray-300' : ''
                            }`}>
                            <div className="flex items-start gap-2">
                                ...
                                {/* 사용자 이름 */}
                                <div className={`chat-head w-24 font-bold text-center cursor-pointer hover:bg-white px-2 py-1 rounded flex-shrink-0 ${message.isNotice ? 'text-blue-600' : 'text-gray-800'
                                    }`}>
                                    {message.username}
                                </div>
